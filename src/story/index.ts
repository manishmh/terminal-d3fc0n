export let LEVEL_1: string = `
 <div class="space-y-3 text-gray-300">
    <span class="text-red-500 mr-2">Mr. Robot: </span> Welcome to
    Fsociety, <span class="text-green-400">[User]</span>. We have been watching you and we believe you have
    what it takes to become one of us.
    </br>
    <div>
      <span class="text-green-400 mr-2">You: </span>One of you ? I
      don&apos;t even know who you are ……. What cause? What&apos;s this
      all about??
    </div>
    </br>
    <div>
      <span class="text-red-500 mr-2">Mr. Robot: </span> We advocate for
      freedom. We fight for you. We champion your cause. But this fight
      requires unwavering commitment.
    </div>
    </br>
    <div>
        <span class="text-red-500 mr-2">Mr. Robot: </span> We're here to disrupt the status quo, to
        revolutionize the corrupt corporations that dominate the
        world. Before we can trust you, we need to see if you're up to
        the task. This page embeds a secret, a key to the next step.
        Can you uncover it?
    </div>
    </br>
    ...
    <div>
      <span class="text-red-400 mr-2">Mr. Robot: </span> E Corp may attempt to bury its secrets deep, and
      yet fsociety knows exactly how to unearth them. While this
      page seems straightforward, there's something concealed within
      the images, something that EvilCorp doesn't want us to see.
      Probe, decipher, unveil.
    </div>
    </br>
    <div>Enter to go back to terminal</div>
    </div> 
`;
...
export const LEVEL_3: string = `
  <div class="text-gray-300 space-y-3">
    <div>
      <span class="text-red-500 mr-2">Mr. Robot: </span> Not bad, not bad at all. Clearly, you know your way
